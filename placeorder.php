...
if ($_SERVER['REQUEST_METHOD']=='POST') {
  $sql="INSERT INTO temp_sale_order1 (SONO,BID, BNAME, BCONTACT, BADDRESS, MEDICINE, QUANTITY, PPQ, PAYMODE, TOTAMOUNT) VALUES ('$sno','$id2', '$sname', '$contact', '$address', '$mname', '$q', '$ppq', '$pay', '$total_amt')";
